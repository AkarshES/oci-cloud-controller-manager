...
var _ = Describe("Lustre E2E Tests", func() {
	...
	Context("[cloudprovider][storage][csi][lustre]", func() {
		...
		It("All the lustre dynamic provisioning and static provisioning tests", func() {
			...
			pvc := pvcJig.CreateAndAwaitPVCOrFailDynamicLustre(f.Namespace.Name, "31200Gi", scName, v1.ClaimPending, nil)
			...
			pv := pvcJig.GetPVByName("csi-lustre-1d651988-7f77-4423-a942-0e08dc64c48e")
			...
			pvc4 := pvcJig.CreateAndAwaitPVCOrFailStaticLustre(f.Namespace.Name, pv4.Name, "31200Gi", nil)
