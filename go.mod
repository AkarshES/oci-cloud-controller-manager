...
require (
	...
	github.com/kubernetes-csi/external-attacher v0.0.0-20220831100725-fff3cc2d1e37 //v4.0.0
...
require bitbucket.oci.oraclecorp.com/cryptography/go_ensurefips v0.0.0-20220825162208-b1975cae9a19
