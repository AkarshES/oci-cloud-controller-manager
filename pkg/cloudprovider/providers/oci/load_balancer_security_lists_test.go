			...
			services: []*v1.Service{
				{
					...
					Spec: v1.ServiceSpec{
						...
						ExternalTrafficPolicy: v1.ServiceExternalTrafficPolicyType(api.ServiceExternalTrafficPolicyTypeCluster),
		...
		},
		{
			...
			services: []*v1.Service{
				...
				},
				{
					...
					Spec: v1.ServiceSpec{
						Type:                  v1.ServiceTypeLoadBalancer,
						ExternalTrafficPolicy: v1.ServiceExternalTrafficPolicyType(api.ServiceExternalTrafficPolicyTypeLocal),
