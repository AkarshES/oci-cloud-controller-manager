		...
		"Assigned Private v4 & v6 IP to NLB": {
			...
			service: &v1.Service{
				ObjectMeta: metav1.ObjectMeta{
					...
					UID:       "test-uid",
					Annotations: map[string]string{
						ServiceAnnotationNetworkLoadBalancerAssignPrivateIpV4: "10.0.0.1",
						ServiceAnnotationNetworkLoadBalancerAssignPrivateIpV6: "2001:0db8:85a3:0000:0000:8a2e:0370:7334",
						ServiceAnnotationLoadBalancerType:                     NLB,
					},
				},
				Spec: v1.ServiceSpec{
		...
		"private IP assignment to LB": {
			...
			service: &v1.Service{
				ObjectMeta: metav1.ObjectMeta{
					...
					UID:       "test-uid",
					Annotations: map[string]string{
						ServiceAnnotationNetworkLoadBalancerAssignPrivateIpV4: "10.1.2.3",
						ServiceAnnotationNetworkLoadBalancerAssignPrivateIpV6: "2001:0db8:85a3:0000:0000:8a2e:0370:7334",
					},
				},
				Spec: v1.ServiceSpec{
