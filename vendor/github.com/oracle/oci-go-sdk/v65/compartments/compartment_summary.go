...
// CompartmentSummary Compartment Summary is a minimal set of attributes of a Compartment object using the API.
...
func (m CompartmentSummary) String() string {
...
func (m CompartmentSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
